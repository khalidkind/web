...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('location.store') }}" id="addlocation">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" name="location_name" maxlength="10"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label">Max Motorcycle</label>
                                <div class="input-group">
                                    <input class="form-control" type="number" name="max_motorcycle" min="0"
                                        placeholder="max 3" required>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="number" name="max_car" min="0"
                                        placeholder="max 3" required>
                                </div>
                                {{-- @error('max_car')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label">Max other</label>
                                <div class="input-group">
                                    <input class="form-control" type="number" name="max_other" min="0"
                                        placeholder="max 3" required>
                                </div>
                                {{-- @error('max_other')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
